      ...
      <div className="tpd-shell">
        ...
        <div className="tpd-hero">
          ...
          <div className="tpd-hero__content">
            ...
            {/* Quick stat pills */}
            <div className="tpd-quick-stats">
              <div className="tpd-stat-pill">
                <span className="tpd-stat-pill__label">Total Price</span>
                <span className="tpd-stat-pill__val">{formatCurrency(pick.price)}</span>
              </div>
              <div className="tpd-stat-pill tpd-stat-pill--green">
                <span className="tpd-stat-pill__label">Advance ({advancePct}%)</span>
                <span className="tpd-stat-pill__val">{formatCurrency(pick.advanceAmount)}</span>
              </div>
              <div className="tpd-stat-pill tpd-stat-pill--amber">
                <span className="tpd-stat-pill__label">Balance</span>
                <span className="tpd-stat-pill__val">{formatCurrency(pick.remainingAmount)}</span>
              </div>
            </div>
          </div>
